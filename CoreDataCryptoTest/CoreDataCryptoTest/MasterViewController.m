...
- (void)insertNewObject:(id)sender {
    ...
    NSInteger personsCount = arc4random_uniform(10);
    NSLog(@"%ld",(long)personsCount);
    
    for ( int i = 0; i < personsCount; i++ ) {
        Person *newPerson = [NSEntityDescription insertNewObjectForEntityForName:@"Person" inManagedObjectContext:context];
        newPerson.name = [NSString stringWithFormat:@"name %d",i];
    ...
    [newManagedObject addRelationship:[NSSet new]];
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
   ...
   // NSLog(@"event.persons = %@",object.relationship);
